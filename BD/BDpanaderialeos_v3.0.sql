...
CREATE TABLE `caja` (
  ...
  `updateregistro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`caja_id`),
...
insert  into `cargo`(`cargo_id`,`cargo`,`descripcion`,`updateregistro`) values (1,'ADMINISTRADOR','ACCESO TOTAL AL SISTEMA','2020-08-03 14:06:07'),(2,'VENDEDOR','ACCESO AL AREA DE VENTAS','2020-08-03 14:06:09'),(3,'PANADERO','ACCESO AL AREA DE PRODUCION','2020-08-03 14:06:14');
...
CREATE TABLE `detalle_pedido` (
  ...
  `cantidad` int(11) NOT NULL,
  `crearegistro` datetime NOT NULL ,
  `updateregistro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `identificacion_cliente` (
  ...
  `descripcion` varchar(100) DEFAULT NULL,
  `fRegistro` datetime NULL DEFAULT NULL,
   `updateregistro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `pedido` (
  ...
  `estado` int(1) NOT NULL,
  `registroElab` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ,
  `cliente_id` char(10) NOT NULL,
